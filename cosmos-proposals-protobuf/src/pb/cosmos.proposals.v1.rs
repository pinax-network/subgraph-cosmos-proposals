...
pub struct VotingParamsOptional {
    ...
    pub expedited_voting_period: ::core::option::Option<::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message, serde::Serialize, serde::Deserialize)]
pub struct TallyParamsOptional {
    ...
    #[prost(string, optional, tag = "2")]
    pub expedited_quorum: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "3")]
    pub threshold: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "4")]
    pub expedited_threshold: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct DepositParamsOptional {
    ...
    pub expedited_min_deposit: ::prost::alloc::vec::Vec<Deposit>,
    #[prost(string, optional, tag = "3")]
